...
typedef NS_ENUM(NSUInteger, ATNativeAttributeModeType) {
    ATNativeAttributeModeTypeImage,
    ATNativeAttributeModeTypeLabel,
    ATNativeAttributeModeTypeView,
};

@interface ATNativeAttributeMode : NSObject
