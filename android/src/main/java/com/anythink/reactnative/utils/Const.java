...
public class Const {
    ...
    /** Optional root map for {@link com.anythink.core.api.ATShowConfig.Builder#customContentResult}. */
    ...
    public static class CallbackKey {
        ...
        public static final String adId = "adId";//native 列表多广告：跨桥 NativeAd 对象引用（同位多条事件分流）
    }
    ...
    public static class Native {
        ...
        // 自渲染 mediaView 占位（SDK getAdMediaView 的 view addView 进它）
        public static final String mediaView = "mediaView";
    ...
    public static class InitCallback {
        ...
        public static final String sdkInitSuccessCallbackKey = "sdkInitSuccess";
        public static final String sdkInitFailCallbackKey = "sdkInitFail";
    }

    /** 桥接错误码（TurboModule reject 用；与 JS 侧 BridgeError 保持一致）。广告 load/show 失败不走此处，只走 Event。 */
    public static class BridgeError {
        public static final String SDK_NOT_INITIALIZED = "SDK_NOT_INITIALIZED";
        public static final String INVALID_PLACEMENT = "INVALID_PLACEMENT";
        public static final String ACTIVITY_NULL = "ACTIVITY_NULL";
        public static final String INVALID_ARGUMENT = "INVALID_ARGUMENT";
    }

    /** 公共广告回调（Revenue 等，callName: CommonADCall）。 */
    ...
    public static class RewardVideoCallback {
        ...
        public static final String RewardFailedCallbackKey = "rewardedVideoDidRewardFailed";
        public static final String AgainRewardFailedCallbackKey = "rewardedVideoDidAgainRewardFailed";
        public static final String DownloadConfirmCallbackKey = "rewardedVideoDidDownloadConfirm";
    ...
    public static class InterstitialCallback {
        ...
        public static final String DownloadConfirmCallbackKey = "interstitialAdDidDownloadConfirm";
    ...
    public static class BannerCallback {
        ...
        public static final String DownloadConfirmCallbackKey = "bannerAdDidDownloadConfirm";
    ...
    public static class NativeCallback {
        ...
        public static final String DownloadConfirmCallbackKey = "nativeAdDidDownloadConfirm";
    ...
    public static class SplashCallback {
        ...
        public static final String DownloadConfirmCallbackKey = "splashDidDownloadConfirm";
    ...
    /** 预留（暂 0 引用，勿当死代码删）：multipleLoaded payload key，后续接入。 */
